    ...
    return (
        <div className='fullpage'>
            ...
            <div className='row'> 
                ...
                <div className='col-4'>
                    <div className='bg-white futureEvents p-3 ps-lg-5 p-lg-4 m-lg-2 bg-white rounded-3 text-center shadow-lg'>
                        <h1 className='text-primary fw-bolder'>{user.username}</h1>
            ...
            <div className="row ">
                ...
                <div className='col-lg-6 col-12'>
                    <div className=' m-5 futureEvents p-4 p-lg-5 bg-white rounded-3 text-center shadow-lg'>
                        <h1 className='text-primary fw-bolder mb-3'>Ha partecipato:</h1>
                        <div className='row gx-lg-5 '>
                            {pastEvents.length > 0 ? (
                                pastEvents.map((event) => {
                                    const data = new Date(event.date);
                                    return (
                                        <div key={event._id} className="event card col-12 col-xxl-6 col-lg-6  mb-5  border-0 bg-transparent text-start " onClick={() => handleEventClick(event._id)}>
                ...
                <div className='col-lg-6 col-12'>
                    <div className=' m-5 futureEvents p-4 p-lg-5 bg-white rounded-3 text-center shadow-lg'>
                        <h1 className='text-primary fw-bolder mb-3'>Parteciperà a:</h1>
                        <div className='row gx-lg-5 '>
